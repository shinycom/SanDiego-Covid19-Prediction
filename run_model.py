...
Sample usage: `python run_model.py`
For help: `python run_model.py --help`
"""
...
def load_best_params_from_file(best_params_dir, country, region=None, subregion=None):
    ...
    if subregion_:
        if country_ == 'US':
            ...
            best_params_fname_search = f'{best_params_dir}/*{country_}_{subregion_}.json'
    elif country_ != 'US':
...
def main(args):
    ...
    if args.best_params_dir:
        ...
        """
        print('---- hard code to use preset parameters here ! -------- ')
    ...
    if args.save_csv:
        ...
        np.savetxt(args.save_csv, combined_arr, '%s', delimiter=',', header=headers)
        print('----------\nSaved file to:', args.save_csv)
...
if __name__ == '__main__':
    ...
    parser.add_argument('--best_params_dir', default='./',
    ...
    parser.add_argument('--region', default='CA',
        help='only necessary if loading params from --best_params_dir')
    parser.add_argument('--subregion', default='San_Diego',
        help='only necessary if loading params from --best_params_dir')
